    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {plans.map((plan) => (
          <div 
            key={plan.name} 
            className={`relative flex flex-col p-8 rounded-2xl backdrop-blur-xl border ${
              plan.isPopular ? 'bg-red-950/20 border-red-500/50 scale-105 z-10' : 'bg-[#111] border-white/10'
