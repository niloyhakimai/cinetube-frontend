  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pb-20">
      ...
      <div className="relative w-full h-[60vh] bg-black border-b border-white/10 overflow-hidden">
        {trailerId ? (
          <iframe 
            className={`w-full h-full object-cover pointer-events-none transition-all duration-700 ${!canPlayMovie ? 'blur-sm opacity-40' : 'opacity-60'}`} 
        ...
        {/* Lock Overlay for Premium Movies */}
        {!canPlayMovie && (
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="bg-[#111]/80 border border-white/10 p-8 rounded-2xl flex flex-col items-center text-center max-w-md shadow-2xl transform hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-yellow-700 rounded-full flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(234,179,8,0.4)]">
                <svg className="w-8 h-8 text-black" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></svg>
              </div>
              <h2 className="text-2xl font-extrabold text-white mb-2 tracking-wide">Premium Content</h2>
              <p className="text-gray-400 mb-6 text-sm">You need an active subscription to watch this movie. Unlock now to get full access.</p>
              <Link 
                href="/#pricing" 
                className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-black px-6 py-3 rounded-xl font-bold transition-all shadow-[0_0_15px_rgba(234,179,8,0.4)] flex items-center justify-center gap-2"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 md:-mt-40 relative z-30">
